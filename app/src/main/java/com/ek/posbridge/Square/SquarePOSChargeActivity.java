package com.ek.posbridge.Square;
...
import com.ek.posbridge.API.Webservices.CreateNewOrderWS;
...
public class SquarePOSChargeActivity extends AppCompatActivity {


    private static final String TAG = SquarePOSChargeActivity.class.getSimpleName();

    private static final int CHARGE_REQUEST_CODE = 0xF00D;
    private String square_appID = "sq0idp-osaXBxTGgbhh3dVDk7MIWQ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_square_charge_pos);
        ...
        posClient = PosSdk.createClient(this, square_appID);
    }
    public SquarePOSChargeActivity(){
    ...
    private void startTransaction() {
        ...
        /*
        *  TOTAL SHOULD BE TAKEN FROM PRODUCTS LIST
        * */
        String amountString = transactionAmountEditText.getText().toString();

        if (totalstr != null){
            amountString = totalstr;
        }else {
        amountString = transactionAmountEditText.getText().toString();
        }
    ...
    private void onTransactionSuccess(ChargeRequest.Success successResult) {
        ...
        if (cashCheckbox.isChecked()){
            CreateNewOrderWS createCashOrder = new CreateNewOrderWS();
            createCashOrder.execute();
            Log.i("CASH ORDER - ", "EXECUTED");
        };
    ...
    /*
    PASSING OVER TOTALSTR FROM PRODUCT LIST ADAPTER TO SET INTO EDITTEXT
    * */

public String SquarePOSChargeActivity(String totalstr){
